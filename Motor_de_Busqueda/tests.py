...
from motor_busqueda_v1 import coef_dice, coef_jaccard, coef_cosine, coef_overlapping
...
class TestBagOfWords(unittest.TestCase):
    ...
    def test_init_with_str(self):
        """Prueba la inicializacion con strings
        """
    ...
    def test_init_with_dict(self):
        """Prueba la inicializacion con diccionarios
        """
    ...
    def test_init_with_symbols_in_str(self):
        """Prueba la inicializacion con strings que contengan simbolos de puntuacion
        """
        self.assertDictEqual(BagOfWords(" cat, dog! cow.").values, {"cat": 1, "dog": 1, "cow": 1})
        self.assertDictEqual(BagOfWords(text="cat dog?? cat!!! ").values, {"cat": 2, "dog": 1})

    def test_str(self):
        """Prueba la conversion a string
        """
    ...
    def test_intersection(self):
        """Prueba la intereseccion de dos bag-of-words
        """
...
class TestCoefs(unittest.TestCase):
    ...
    def test_coef_dice(self):
        ...
        """
        bag1 = BagOfWords("dog cat cow fish dog dog fish")
        bag2 = BagOfWords("cat grape banana dog")
